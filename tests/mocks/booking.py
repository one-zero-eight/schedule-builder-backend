...
class MockBookingService:
    async def get_room_bookings(self, room_id: str, start: datetime, end: datetime) -> list[BookingDTO]:
        return []

    async def get_all_bookings(self, start: datetime, end: datetime) -> list[BookingDTO]:
        return []
